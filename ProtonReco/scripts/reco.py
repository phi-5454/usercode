...
options.register('inFile', None,
                 VarParsing.multiplicity.singleton,
                 VarParsing.varType.string,
                 'What directory to output the resulting file to'
                 )
...
pathPrefix = "root://eostotem//eos/totem/data/cmstotem/2018/90m/RECO_copy/";

print(pathPrefix + options.inFile)

process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring(pathPrefix + options.inFile),
                            duplicateCheckMode = cms.untracked.string('noDuplicateCheck') 
                            )
